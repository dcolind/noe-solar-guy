...
<h3 className="absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl animate-pulse">Contact Me
      </h3>
      ...
      <div className="flex flex-col space-y-10 pt-40">
        ...
        >
          ...
          <button
            type="submit"
            className="
            bg-blue-400 py-5 px-10 rounded-md text-black font-bold text-lg "
          >
            Submit
          </button>
        </form>
